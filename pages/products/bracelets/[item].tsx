...
export const getStaticPaths: GetStaticPaths = async () => {
  return {
    paths: [
      { params: { item: 'black-silver' } },
      { params: { item: 'black-white-bead' } },
      { params: { item: 'blue-diamond-pink' } },
      { params: { item: 'green-white' } },
      { params: { item: 'light-dark' } },
      { params: { item: 'pink-white-crystal' } },
      { params: { item: 'pink-white-pearl' } },
      { params: { item: 'pink-white-dice-stars' } },
      { params: { item: 'pink-white-black' } },
      { params: { item: 'purple-white' } },
      { params: { item: 'red-black-stars' } },
